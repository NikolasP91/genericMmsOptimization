...
PENALTY_FIELDS = (
    ...
    "x_max_oper_state_time",
    "x_max_oper_state_time_left",
    "x_max_oper_state_time_b",
    "x_max_oper_state_time_b_left",
    "x_min_oper_state_time_a",
    "x_min_oper_state_time_a_left",
    "x_min_oper_state_time_b",
    "x_min_oper_state_time_b_left",
